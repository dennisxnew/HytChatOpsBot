...
const { ShowLogInput } = require('../bean/ShowLogInput');
const { UserProfile } = require('../bean/userProfile');

const REVIEW_SELECTION_DIALOG = 'REVIEW_SELECTION_DIALOG';
const TEXT_PROMPT = 'TEXT_PROMPT';
const NUMBER_PROMPT = 'NUMBER_PROMPT';
const SHOWLOG_DIALOG = 'SHOWLOG_DIALOG';
const WATERFALL_DIALOG = 'WATERFALL_DIALOG';

class ShowLogDialog extends ComponentDialog {

    constructor(){
        super(SHOWLOG_DIALOG);
...
module.exports.ShowLogDialog = ShowLogDialog;
module.exports.SHOWLOG_DIALOG = SHOWLOG_DIALOG;
